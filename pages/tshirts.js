    ...
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          {Object.keys(products).length === 0 && <p>Sorry All Tshirts were sold out next stock comingsoon stay tuned!</p>}
              ...
              return <div key={ products[item]._id } className="lg:w-1/4 md:w-1/4 p-4 w-full shadow-md cursor-pointer md:mx-5">
                <Link passHref={true} href={ `product/${products[item].slug}` }><div className="block relative h-48 rounded overflow-hidden">
                  ...
                  <div className="text-center mt-4 md:text-left">
                    ...
                    <div className="mt-1">
                      {products[item].color.includes("red") && <button className="bg-red-700 border-2 border-gray-300 rounded-full w-6 h-6 focus:outline-none"></button>}

                      {products[item].color.includes("blue") && <button className="bg-blue-700 border-2 border-gray-300 rounded-full w-6 h-6 focus:outline-none"></button>}
                      ...
                      {products[item].color.includes("green") && <button className="bg-green-700 border-2 border-gray-300 rounded-full w-6 h-6 focus:outline-none"></button>}

                      {products[item].color.includes("yellow") && <button className="bg-yellow-700 border-2 border-gray-300 rounded-full w-6 h-6 focus:outline-none"></button>}
